      ...
      <div className="space-y-6">
        ...
        <div className="relative overflow-hidden rounded-xl shadow-2xl aspect-[1200/630] w-full max-w-4xl mx-auto">
          ...
          <div className="relative h-full flex flex-col items-center justify-center p-8 text-center text-white">
            ...
            <div className={`space-y-6 max-w-2xl ${formData.template === 'modern'
              ? 'bg-white/10 backdrop-blur-sm p-8 rounded-2xl'
              : ''
              }`}>
              <h2 className={`text-4xl font-bold mb-6 ${formData.template === 'modern'
              ...
              <p className={`text-xl leading-relaxed whitespace-pre-wrap ${formData.template === 'modern'
                ? 'text-white/90'
                : ''
                }`}>
                {formData.message}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        {PREDEFINED_IMAGES.map((image) => (
          <button
            ...
            className={`relative aspect-video rounded-lg overflow-hidden group ${formData.backgroundImage === image.url
    ...
    <div className="py-4">
      ...
      <div className="flex justify-center mb-8">
        <div className="flex items-center">
          <div className={`w-10 h-10 rounded-full flex items-center justify-center ${step >= 1 ? 'bg-pink-500 text-white' : 'bg-gray-200 text-gray-500'
            }`}>1</div>
          <div className={`w-20 h-1 ${step >= 2 ? 'bg-pink-500' : 'bg-gray-200'}`} />
          <div className={`w-10 h-10 rounded-full flex items-center justify-center ${step >= 2 ? 'bg-pink-500 text-white' : 'bg-gray-200 text-gray-500'
            }`}>2</div>
          <div className={`w-20 h-1 ${step >= 3 ? 'bg-pink-500' : 'bg-gray-200'}`} />
          <div className={`w-10 h-10 rounded-full flex items-center justify-center ${step >= 3 ? 'bg-pink-500 text-white' : 'bg-gray-200 text-gray-500'
            }`}>3</div>
          <div className={`w-20 h-1 ${step >= 4 ? 'bg-pink-500' : 'bg-gray-200'}`} />
          <div className={`w-10 h-10 rounded-full flex items-center justify-center ${step >= 4 ? 'bg-pink-500 text-white' : 'bg-gray-200 text-gray-500'
            }`}>4</div>
        </div>
      </div>
        ...
        {step === 2 && (
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className={`p-4 rounded-lg border-2 ${formData.template === 'classic'
            ...
            <button
              ...
              className={`p-4 rounded-lg border-2 ${formData.template === 'modern'
                ? 'border-pink-500 bg-pink-50 dark:bg-pink-900'
                : 'border-gray-200 dark:border-gray-700 hover:border-pink-300'
                }`}
            >
